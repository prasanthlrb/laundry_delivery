...
class DeliveryDetails extends StatefulWidget {
  int _id;
  DeliveryDetails(this._id);
  @override
  _DeliveryDetailsState createState() => _DeliveryDetailsState(_id);
}
...
class _DeliveryDetailsState extends State<DeliveryDetails> {
  ...
  Future<void> _itemPickup() async {
    final response =
        await http.get("${httpAddr.url}api/item-delivery/${widget._id}");
    if (response.statusCode == 200) {
